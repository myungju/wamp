...
Then go to your browser at http://localhost:83/phpinfo.php
...
will be accessible at http://localhost:83/demo

You should copy the "demo" folder into the C:/Bitnami/wampstack-5.6.31-0/apps 
folder and add the following line at the end of the
C:/Bitnami/wampstack-5.6.31-0/apache2/conf/bitnami/bitnami-apps-prefix.conf

Include "C:/Bitnami/wampstack-5.6.31-0/apps/demo/conf/httpd-prefix.conf"

Then restart the Apache server. You can use the graphical Manager tool 
that you can find in your installation directory.

Go to your browser at http://localhost:83/demo and
...
configuration in the "C:/Bitnami/wampstack-5.6.31-0/apache2/conf/bitnami/bitnami-apps-prefix.conf" file

#Include "C:/Bitnami/wampstack-5.6.31-0/apps/demo/conf/httpd-prefix.conf"

and enable the new Virtual Host configuration file in the 
"C:/Bitnami/wampstack-5.6.31-0/apache2/conf/bitnami/bitnami-apps-vhosts.conf" file:

Include "C:/Bitnami/wampstack-5.6.31-0/apps/demo/conf/httpd-vhosts.conf"
